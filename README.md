...
## updates
- (9 Feb 2018) [Patient Phenome UI](https://github.com/CogStack/SemEHR/tree/master/UI/patient_phenome_ui) implemented - for use cases like 100k GeL phenome model that is essentially using HPO terms modelling patients. ![System Achitecture](https://raw.githubusercontent.com/CogStack/SemEHR/master/resources/HPO_Phenome_Model.png "HPO Phenome Model")
